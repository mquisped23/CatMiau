 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://Services/", wsdlLocation = "http://localhost:8080/Servicios_Chat/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://Services/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Servicios_Chat/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://Services/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services/", "ServiciosPort"), Servicios.class, features);
    }
