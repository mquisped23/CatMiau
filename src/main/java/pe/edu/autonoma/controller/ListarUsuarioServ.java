 ...
 * @author andro
 */
public class ListarUsuarioServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       r  = registro.list();
       request.setAttribute("datos", r);
        request.getRequestDispatcher("tablaListaUsuarios.jsp").forward(request, response);
